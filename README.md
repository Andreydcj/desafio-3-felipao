...
Funcionalidades:
    ...
    Validação de Dados: Sistema de segurança que impede o fechamento do programa caso o usuário digite letras no lugar de números ou opções inválidas.

    Programação Orientada a Objetos: Utiliza classes para estruturar os dados do herói e seus comportamentos (ataques).
